...
class Jsoniframe_Controller extends Template_Controller
{
...
*/			
        ...
        {			
            ...
            $json_item .= "\"name\":\"" . str_replace(chr(10), ' ', str_replace(chr(13), ' ', "<a href='" . url::base() . "reports/view/" . $marker->id . "' target='_blank'>" . htmlentities(utf8_decode($marker->incident_title)) . "</a>")) . "\",";
