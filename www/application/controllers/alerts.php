        ...
        if ($_POST)
        {
            ...
            if ($post->validate())
            {
				...
				if (!empty($post->alert_email))
				{
					...
					$message = "Por favor da click en http://www.cuidemoselvoto.org/alerts/verify/".$alert_code.
                               " para confirmar tu e-mail y recibir alertas.<br/><br/>Atte<br/>El equipo de Cuidemoselvoto.org";
