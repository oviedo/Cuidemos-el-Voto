...
?>
		...
		jQuery(function() {
			...
			*/
			...
			var markers = new OpenLayers.Layer.GML("reports", "<?php echo url::base() . 'index.php/jsoniframe' ?>", 
			{
			...
			$("a[@id^='cat_']").click(function() {
				...
				markers.setUrl("<?php echo url::base() . 'index.php/jsoniframe/?c=' ?>" + catID);
			});
			...
			$("select#startDate, select#endDate").accessibleUISlider({
				...
				stop: function(e, ui) {
					...
					$.timeline({categoryId: currentCat, startTime: new Date(startDate * 1000), 
						...
						url: "<?php echo url::base() . 'index.php/jsoniframe/timeline/' ?>"
					}).plot();
				}
			});
