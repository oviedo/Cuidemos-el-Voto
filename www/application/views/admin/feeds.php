...
?>
			<div class="bg">
				<h2>
					...
					<a href="<?php echo url::base() . 'admin/manage/feeds' ?>" class="active">Feeds de Noticias</a>
				...
				<div class="tabs">
					...
					<div class="tab">
						<ul>
							<li><a href="javascript:refreshFeeds();">REFRESCAR LOS FEEDS</a></li><span id="feeds_loading"></span>
						</ul>
					</div>
				</div>
				<?php
				...
				<div class="tabs">
					...
					<a name="add"></a>
					<ul class="tabset">
						<li><a href="#" class="active">Agregar/Modificar</a></li>
					</ul>
					<!-- tab -->
					<div class="tab">
						...
						<div class="tab_form_item">
							<strong>Nombre del Feed:</strong><br />
							<?php print form::input('feed_name', '', 
							' class="text"'); ?>
						</div>
						<div class="tab_form_item">
							<strong>URL del Feed:</strong><br />
