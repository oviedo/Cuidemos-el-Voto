			...
			<div class="bg">
				...
				<div class="report-form">
					...
					<div class="sms_nav_holder">
						<a href="<?php echo url::base() . 'admin/settings/smseflyer' ?>">Option 1: Use Eflyer</a>
						<a href="<?php echo url::base() . 'admin/settings/sms' ?>">Option 2: Use Frontline SMS</a>
						<a href="<?php echo url::base() . 'admin/settings/smsglobal' ?>" class="active">Option 3: Use a Global SMS Gateway</a>
					</div>
