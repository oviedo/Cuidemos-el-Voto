...
<head>
	...
	<title>Ushahidi Engine -Cuidemos el voto-</title>
	...
	<div class="holder">
		...
		<div id="header">
			...
			<div class="top">
				...
				<ul>
					<li class="none-separator">Bienvenido, <?php echo $admin_name; ?>!</li>
					<li class="none-separator"><a href="<?php echo url::base() ?>" title="View the home page">Ver el sitio</a>					
					<li class="none-separator"><a href="#">Mi Perfil</a></li>
					<li><a href="log_out">Cerrar sesi&oacute;n</a></li>
				</ul>
			</div>
			<!-- info-nav -->
			<div class="info-nav">
				...
				<ul>
					...
					<li><a href="http://forums.ushahidi.com/">Foro</a></li>
				</ul>
			</div>
			<!-- title -->
			...
			<div class="nav-holder">
				<!-- main-nav -->
				<ul class="main-nav">
					<li><a href="<?php echo url::base() ?>admin/dashboard" <?php if($this_page=="dashboard") echo "class=\"active\"" ;?>>Panel de Control </a></li>
					<li><a href="<?php echo url::base() ?>admin/reports" <?php if($this_page=="reports") echo "class=\"active\"" ;?>>Reportes</a></li>
					<li><a href="<?php echo url::base() ?>admin/messages" <?php if($this_page=="messages") echo "class=\"active\"" ;?>>Mensajes</a></li>
				...
				<!-- sub-nav -->
				<ul class="sub-nav">
					<?php if ($this->auth->logged_in('admin')){ ?><li><a href="<?php echo url::base() ?>admin/settings/site">Configuraci&oacute;n</a></li>
					<li><a href="<?php echo url::base() ?>admin/users">Usuarios</a></li>
