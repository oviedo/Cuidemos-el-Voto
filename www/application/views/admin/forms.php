...
?>	
		<div class="bg">
			<h2>
				<a href="<?php echo url::base() . 'admin/manage' ?>">Categorias</a>
				<a href="<?php echo url::base() . 'admin/manage/forms' ?>" class="active">Formularioss</a>
				<span>(<a href="#add">Agregar nuevo</a>)</span>
				<a href="<?php echo url::base() . 'admin/manage/organizations' ?>">Organizaciones</a>
				<a href="<?php echo url::base() . 'admin/manage/feeds' ?>">Feeds</a>
			...
			?>
				<!-- green-box -->
				<div class="green-box">
					<h3>El formulario ha sido <?php echo $form_action; ?>!</h3>
				</div>
			<?php
			}
			?>
						...
						<tbody>
							...
							?>
								<tr>
									<td colspan="4" class="col">
										<h3>No se econtraron resultados!</h3>
									</td>
								</tr>
							<?php	
							}
							foreach ($forms as $form)
							{
								...
								foreach ($fields as $field)
								{
									...
									<a href=\"javascript:fieldAction('e','EDIT',".$field_id.",".$form_id.",".$field_type.");\">MODIFICAR</a>&nbsp;|&nbsp;
									<a href=\"javascript:fieldAction('d','DELETE',".$field_id.",".$form_id.",".$field_type.");\">BORRAR</a>&nbsp;|&nbsp;
									<a href=\"javascript:fieldAction('mu','MOVE',".$field_id.",".$form_id.",".$field_type.");\">MOVER ARRIBA</a>&nbsp;|&nbsp;
									<a href=\"javascript:fieldAction('md','MOVE',".$field_id.",".$form_id.",".$field_type.");\">MOVER ABAJO</a></div>";
									$form_fields .= "</div>";
								}
								$form_fields .= "</form>";
								?>
								<?php print form::open(NULL,array('id' => 'form_action_' . $form_id,
									...
									<tr id="tr_<?php echo $form_id; ?>">
										...
										<td class="col-2">
											<div class="post">
												<h4><?php echo $form_title; ?>&nbsp;&nbsp;&nbsp;[<a href="javascript:showForm('formDiv_<?php echo $form_id; ?>')">Modificar los campos de los formularioss</a></li>]</h4>
										...
										<td class="col-4">
											<ul>
												<li class="none-separator"><a href="#add" onClick="fillFields('<?php echo(rawurlencode($form_id)); ?>','<?php echo(rawurlencode($form_title)); ?>','<?php echo(rawurlencode($form_description)); ?>')">Modificar</a></li>
												<li class="none-separator"><a href="javascript:formAction('a','SHOW/HIDE','<?php echo(rawurlencode($form_id)); ?>')"<?php if ($form_active) echo " class=\"status_yes\"" ?>>Activa</a></li>
												<li><a href="javascript:formAction('d','DELETE','<?php echo(rawurlencode($form_id)); ?>')" class="del">Borrar</a></li>
											</ul>
										</td>
									</tr>
								...
								<tr style="margin:0;padding:0;border-width:0;">
									<td colspan="4" style="margin:0;padding:0;border-width:0;">
										<div id="formDiv_<?php echo $form_id; ?>" class="forms_fields">
											<a href="javascript:addNewForm('<?php echo $form_id; ?>')" class="new-form_field">Agregar nuevo campo</a>
												...
												<div class="tab">
													<div>
														<?php echo form::open(url::base() . 'admin/manage/forms/field_add', array('id' => 'form_field_'.$form_id,
															...
															<strong>Selecciona un tipo de campo:</strong>
			...
			<div class="tabs">
				...
				<div class="tab">
					...
					<div class="tab_form_item">
						<strong>T&iacute;tulo del Formulario:</strong><br />
